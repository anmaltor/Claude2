        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:block">
            <div className="ml-10 flex space-x-8">
              ...
              <Link href="/forecast" className="text-gray-700 hover:text-blue-600 px-3 py-2 text-sm font-medium">
                Forecast
              </Link>
            </div>
          </div>
      ...
      {isOpen && (
        <div className="md:hidden">
          <div className="px-2 pt-2 pb-3 space-y-1">
            ...
            <Link href="/forecast" className="text-gray-700 hover:text-blue-600 block px-3 py-2 text-base font-medium">
              Forecast
            </Link>
          </div>
        </div>
